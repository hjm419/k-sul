              ...
              Container(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    safeSetState(() {});
                    FFAppState().RecommendNMTF1 =
                    !(FFAppState().RecommendNMTF1 ?? true);
                    FFAppState().update(() {});
                  },
                  text: '상관없음',
                  options: FFButtonOptions(
